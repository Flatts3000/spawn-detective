...
final class WorldRuleTests {
    ...
    static void register() {
        ...
        SDGameTests.test("peaceful_stops_monsters_only", 40, WorldRuleTests::peacefulStopsMonstersOnly);
     ...
     */
    private static void peacefulStopsMonstersOnly(GameTestHelper helper) {
        ...
        helper.runAfterDelay(20L, () -> {
            ...
            boolean spawning = helper.getLevel().getGameRules().get(GameRules.SPAWN_MOBS);
            try {
                ...
                helper.getLevel().getGameRules().set(GameRules.SPAWN_MOBS, true, helper.getLevel().getServer());
                ...
                helper.getLevel().getGameRules().set(GameRules.SPAWN_MOBS, spawning, helper.getLevel().getServer());
            }
            helper.succeed();
        });
    }
