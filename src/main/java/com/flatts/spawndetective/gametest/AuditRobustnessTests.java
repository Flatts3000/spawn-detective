...
final class AuditRobustnessTests {
    ...
    static void register() {
        ...
        SDGameTests.test("caveat_never_contradicts_evidence", 1,
            AuditRobustnessTests::caveatNeverContradictsEvidence);
        SDGameTests.test("candidate_rules_stay_in_pipeline_order", 1,
            AuditRobustnessTests::candidateRulesStayInPipelineOrder);
        SDGameTests.test("informational_rules_never_block", 1, AuditRobustnessTests::informationalRulesNeverBlock);
    }
     ...
     */
    private static void caveatNeverContradictsEvidence(GameTestHelper helper) {
     ...
     */
    private static void candidateRulesStayInPipelineOrder(GameTestHelper helper) {
        BlockPos pos = helper.absolutePos(new BlockPos(1, 2, 1));
     ...
     */
    private static void informationalRulesNeverBlock(GameTestHelper helper) {
        ServerLevel level = helper.getLevel();
        BlockPos here = helper.absolutePos(new BlockPos(1, 2, 1));

        int[] heights = {
            level.getMinY() - 8, level.getMinY(), level.getMinY() + 1,
            here.getY(), here.getY() + 64, level.getMaxY(), level.getMaxY() + 8
        };
