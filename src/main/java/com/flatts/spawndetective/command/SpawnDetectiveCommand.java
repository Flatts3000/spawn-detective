package com.flatts.spawndetective.command;
 ...
 *
 * <pre>
 *   /spawndetective                        audit where the caller is standing
 *   /spawndetective at &lt;pos&gt;               audit a position
 *   /spawndetective for &lt;entity&gt;           audit one mob type here
 *   /spawndetective at &lt;pos&gt; for &lt;entity&gt;  audit one mob type at a position
 * </pre>
 *
 ...
 * poll at will.
 */
@EventBusSubscriber(modid = SpawnDetective.MOD_ID)
public final class SpawnDetectiveCommand {

    private SpawnDetectiveCommand() {
    }
        ...
        dispatcher.register(Commands.literal("spawndetective")
            ...
            .then(Commands.literal("at")
                .then(Commands.argument("pos", BlockPosArgument.blockPos())
                    ...
                    .then(forArgument(build, SpawnDetectiveCommand::argPos)))));
    }
