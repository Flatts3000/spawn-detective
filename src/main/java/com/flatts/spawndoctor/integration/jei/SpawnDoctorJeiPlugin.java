package com.flatts.spawndoctor.integration.jei;
 ...
 */
@JeiPlugin
public class SpawnDoctorJeiPlugin implements IModPlugin {

    private static final Identifier UID =
        Identifier.fromNamespaceAndPath(SpawnDoctor.MOD_ID, "jei");
    ...
    public void registerRecipes(IRecipeRegistration registration) {
        registration.addIngredientInfo(
            ...
            Component.translatable("spawndoctor.jei.probe.what"),
            Component.translatable("spawndoctor.jei.probe.anchor"),
            Component.translatable("spawndoctor.jei.probe.read"),
            Component.translatable("spawndoctor.jei.probe.why"));
    }
}
